...
namespace jobworld.Common
{
    ...
    public class Defines
    {
        ...
        #region 페이지 관련 정보
        public static string ABS_ADVERTISEMENT_PATH
        {
            get { return ConfigurationManager.AppSettings["ABS_ADVERTISEMENT_PATH"]; }
        }

        public static string ABS_CONTENT_PATH
        {
            get { return ConfigurationManager.AppSettings["ABS_CONTENT_PATH"]; }
        }
        ...
        {
            get { return ConfigurationManager.AppSettings["ABS_PATH"]; }
        }

        public static string FILE_CONTENT_PATH
        {
            get { return ConfigurationManager.AppSettings["FILE_CONTENT_PATH"]; }
        }
        ...
        public static string ADV_PATH
        {
            get { return ConfigurationManager.AppSettings["ADV_PATH"]; }
        }
